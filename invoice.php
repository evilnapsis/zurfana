...
if(count($products)){
    ...
    foreach($products as $itemx){
        ...
        $mtx=null;
         ...
         $this->setX(180);
         $this->Cell(0,10,$coin." ".number_format($item->price,2,".",","));
...
///////////////////////////////////////////////////////////// Total
        $this->SetFont('Arial','',12);
         ...
         $this->setX(20);
         $this->Cell(0,10,"SubTotal:          ".$coin. " ".number_format($total*(1-($iva/100)),2,".",","));
         $starty+=5;
         $this->setY(125+$starty);
         $this->setX(20);
         ...
         $this->setY(125+$starty);
         $this->setX(20);
         $this->Cell(0,10,"Total:                 ".$coin. " ".number_format($total,2,".",","));
