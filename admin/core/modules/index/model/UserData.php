...
class UserData {
	...
	public function register(){
		$sql = "insert into user (is_active,activation_code,name,lastname,email,password,created_at) ";
		$sql .= "value (0,\"$this->activation_code\",\"$this->name\",\"$this->lastname\",\"$this->email\",\"$this->password\",$this->created_at)";
...
// partiendo de que ya tenemos creado un objecto UserData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		while($r = $query[0]->fetch_array()){
			...
			$data->activation_code = $r['activation_code'];
