...
<?php foreach($categories as $cat):?>
                        ...
                        <a href="index.php?action=setsid&sid=3&product_id=<?php echo $cat->id; ?>"  class="btn btn-default btn-xs"><i class="fa fa-check"></i> Publicar</a> 
                        <a href="index.php?action=setsid&sid=4&product_id=<?php echo $cat->id; ?>"  class="btn btn-default btn-xs"><i class="fa fa-remove"></i> Rechazar</a> 
