...
insert into s (name) value ("Pendiente"),("En Revision"),("Publicado"),("Rechazado");
...
create table contact (
	...
	is_answer boolean not null default 0,
...
insert into paymethod(short_name,name) value ("paypal", "Paypal"),("bank", "Deposito Bancario"),("deliver", "Contra entrega");
...
insert into configuration(name,label,kind,val) value ("general_base","Base Host",1,"");
insert into configuration(name,label,kind,val) value ("general_main_title","Titulo Principal",1,"ZURFANA");
...
insert into configuration(name,label,kind,val) value ("general_iva_txt","Impuesto Texto",1,"I.G.I");
