...
<!--  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <textarea class="form-control" id="inputPassword1" placeholder="Comentarios" rows="3" name="comments"></textarea>
    </div>
  </div>
  <div class="form-group">
  ...
  <input type="text" class="form-control" placeholder="Precio" required name="price">
    ...
    <div class="col-lg-2">
      <input type="text" class="form-control" name="brand" placeholder="Marca del producto">
    </div>

    <label for="inputEmail1" class="col-lg-2 control-label">Modelo</label>
    <div class="col-lg-2">
      <input type="text" class="form-control" name="model" placeholder="Modelo del producto">
    </div>

    <label for="inputEmail1" class="col-lg-2 control-label">A&ntilde;o Fab.</label>
    <div class="col-lg-2">
      <input type="text" class="form-control" name="y" placeholder="A&ntilde;o Fab. del producto">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <label for="inputEmail1" class="col-lg-3 control-label">Imagen 2</label>
    <div class="col-lg-3">
      <input type="file" name="image2">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">Imagen 3</label>
    <div class="col-lg-3">
      <input type="file" name="image3">
    </div>
    <label for="inputEmail1" class="col-lg-3 control-label">Imagen 4</label>
    <div class="col-lg-3">
